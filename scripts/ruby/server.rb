...
loop do
	...
	if menu == "1"
		...
		# server.send "message-to-self", 0, "127.0.0.1", p

		# b = server.recvfrom(1024).first
		...
		# loop do
			...
			# server.send(response, 0, host, port)
		# end
		...
		loop do
			...
			begin
				...
				if true
					...
					sock_domain, remote_port, remote_hostname, remote_ip = client.addr
